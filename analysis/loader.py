...
def build_legacy_metadata(manifest: InfluenceResultsManifest) -> dict[str, Any]:
    ...
    meta: dict[str, Any] = {
        ...
        "n_train_replay_cap": config.get("n_train_replay_cap"),
        "train_replay_pool_size": config.get("train_replay_pool_size"),
        "train_replay_subset_seed": config.get("train_replay_subset_seed"),
...
def _manifest_from_legacy_metadata(results_path: Path) -> InfluenceResultsManifest:
    ...
    config = {
        ...
        "n_train_replay_cap": metadata.get("n_train_replay_cap"),
        "train_replay_pool_size": metadata.get("train_replay_pool_size"),
        "train_replay_subset_seed": metadata.get("train_replay_subset_seed"),
