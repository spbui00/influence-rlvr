...
def load_mixed_train_dataset(args):
    ...
    ds = ds.map(lambda _, idx: {"train_index": idx}, with_indices=True)
    return ds
...
def main():
    ...
    if args.mixed:
        ...
        train_dataset = load_mixed_train_dataset(args)
    else:
